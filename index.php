...
function checkYahoo($user){
    ...
    curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36"); 
...
function checkProtonmail($mail){
  ...
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL,"https://old.protonmail.com/api/auth/info?login");
  curl_setopt($ch,CURLOPT_HTTPHEADER, [
    'Host: old.protonmail.com',
'Connection: keep-alive',
'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36',
'Accept: application/vnd.protonmail.v1+json',
'Origin: https://old.protonmail.com',
'Sec-Fetch-Site: same-site',
'Sec-Fetch-Mode: navigate',
'Referer: https://old.protonmail.com/login',
'Accept-Encoding: gzip, deflate, br',
'Accept-Language: en-US,en;q=0.9'
    ]);
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
